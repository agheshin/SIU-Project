...
<!-- ------------------------------- Top menu ------------------------------- -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Sistemul informational ULIM</a>
            </div>
            <!-- /.navbar-header -->
            <!-- ------------------------------- Messages------------------------------- -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            <a href="'; echo $server_url; echo'/includes/main_frame_sheet.php?a=nom_discipline"><i class="fa fa-files-o fa-fw"></i> Discipline</a>
                        </li>
                        <li class="active">
                            <a href="'; echo $server_url; echo'/includes/main_frame_sheet.php?a=nom_plan_studii"><i class="fa fa-files-o fa-fw"></i> Plan de studii</a>
                        </li>
                        <li class="active">
                            <a href="'; echo $server_url; echo'/includes/main_frame_sheet.php?a=grupe"><i class="fa fa-files-o fa-fw"></i> Administrare grupe</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Statistica</a>                            
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Tabele</a>
                        </li>                                            
        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <!-- ------------------------------- Page Content ------------------------------- -->';
                    switch ($action)
                       { 
                        case "":                      echo show_alert('success','Autentificare reusita.'); break;
